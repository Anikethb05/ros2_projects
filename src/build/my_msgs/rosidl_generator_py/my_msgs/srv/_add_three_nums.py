...
class Metaclass_AddThreeNums(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_msgs.srv import _add_three_nums
...
class AddThreeNums(metaclass=Metaclass_AddThreeNums):
    from my_msgs.srv._add_three_nums import AddThreeNums_Request as Request
    from my_msgs.srv._add_three_nums import AddThreeNums_Response as Response
