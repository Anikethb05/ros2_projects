...
#include "my_msg_srv/msg/detail/my_msg__rosidl_typesupport_fastrtps_c.h"
...
using _MyMsg__ros_msg_type = my_msg_srv__msg__MyMsg;
...
size_t get_serialized_size_my_msg_srv__msg__MyMsg(
  const void * untyped_ros_message,
...
static uint32_t _MyMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_msg_srv__msg__MyMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msg_srv
size_t max_serialized_size_my_msg_srv__msg__MyMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msg_srv__msg__MyMsg;
    is_plain =
      (
      offsetof(DataType, a) +
      last_member_size
...
static size_t _MyMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_msg_srv__msg__MyMsg(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msg_srv, msg, MyMsg)() {
