...
#include "my_msg_srv/srv/detail/add_three_nums__rosidl_typesupport_fastrtps_c.h"
...
#include "my_msg_srv/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _AddThreeNums_Request__ros_msg_type = my_msg_srv__srv__AddThreeNums_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msg_srv
size_t get_serialized_size_my_msg_srv__srv__AddThreeNums_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddThreeNums_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_msg_srv__srv__AddThreeNums_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msg_srv
size_t max_serialized_size_my_msg_srv__srv__AddThreeNums_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msg_srv__srv__AddThreeNums_Request;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
static size_t _AddThreeNums_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_msg_srv__srv__AddThreeNums_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msg_srv, srv, AddThreeNums_Request)() {
...
using _AddThreeNums_Response__ros_msg_type = my_msg_srv__srv__AddThreeNums_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msg_srv
size_t get_serialized_size_my_msg_srv__srv__AddThreeNums_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddThreeNums_Response__ros_msg_type * ros_message = static_cast<const _AddThreeNums_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_msg_srv__srv__AddThreeNums_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msg_srv
size_t max_serialized_size_my_msg_srv__srv__AddThreeNums_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_msg_srv__srv__AddThreeNums_Response;
    is_plain =
      (
...
static size_t _AddThreeNums_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_msg_srv__srv__AddThreeNums_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msg_srv, srv, AddThreeNums_Response)() {
...
// already included above
// #include "my_msg_srv/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_msg_srv/srv/add_three_nums.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msg_srv, srv, AddThreeNums)() {
