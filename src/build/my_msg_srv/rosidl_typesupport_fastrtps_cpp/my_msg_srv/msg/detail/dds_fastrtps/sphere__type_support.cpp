...
#include "my_msg_srv/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_msg_srv::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_msg_srv::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msg_srv::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_msg_srv::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_msg_srv::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &my_msg_srv::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_msg_srv, msg, Sphere)() {
  return &my_msg_srv::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
