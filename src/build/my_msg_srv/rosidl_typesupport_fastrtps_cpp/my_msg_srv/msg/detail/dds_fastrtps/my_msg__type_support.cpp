...
#include "my_msg_srv/msg/detail/my_msg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msg_srv::msg::MyMsg;
    is_plain =
      (
      offsetof(DataType, a) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const my_msg_srv::msg::MyMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_msg_srv::msg::MyMsg *>(
    untyped_ros_message);
...
{
  return &my_msg_srv::msg::typesupport_fastrtps_cpp::_MyMsg__handle;
}
