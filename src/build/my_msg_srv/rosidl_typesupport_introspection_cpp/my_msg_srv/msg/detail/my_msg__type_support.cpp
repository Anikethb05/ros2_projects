...
{
  new (message_memory) my_msg_srv::msg::MyMsg(_init);
}

void MyMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_msg_srv::msg::MyMsg *>(message_memory);
  typed_message->~MyMsg();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MyMsg_message_member_array[1] = {
  {
    ...
    offsetof(my_msg_srv::msg::MyMsg, a),  // bytes offset in struct
...
{
  return &::my_msg_srv::msg::rosidl_typesupport_introspection_cpp::MyMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_msg_srv, msg, MyMsg)() {
  return &::my_msg_srv::msg::rosidl_typesupport_introspection_cpp::MyMsg_message_type_support_handle;
}
