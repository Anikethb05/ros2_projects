...
my_msg_srv__msg__Sphere__init(my_msg_srv__msg__Sphere * msg)
{
  ...
  if (!geometry_msgs__msg__Point__init(&msg->center)) {
    my_msg_srv__msg__Sphere__fini(msg);
    return false;
  }
  // radius
  return true;
...
my_msg_srv__msg__Sphere__create()
{
  ...
  my_msg_srv__msg__Sphere * msg = (my_msg_srv__msg__Sphere *)allocator.allocate(sizeof(my_msg_srv__msg__Sphere), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_msg_srv__msg__Sphere));
  bool success = my_msg_srv__msg__Sphere__init(msg);
  if (!success) {
...
my_msg_srv__msg__Sphere__Sequence__init(my_msg_srv__msg__Sphere__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_msg_srv__msg__Sphere * data = NULL;

  if (size) {
    data = (my_msg_srv__msg__Sphere *)allocator.zero_allocate(size, sizeof(my_msg_srv__msg__Sphere), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_msg_srv__msg__Sphere__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_msg_srv__msg__Sphere__fini(&data[i - 1]);
      }
...
my_msg_srv__msg__Sphere__Sequence__fini(my_msg_srv__msg__Sphere__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_msg_srv__msg__Sphere__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_msg_srv__msg__Sphere__Sequence * array = (my_msg_srv__msg__Sphere__Sequence *)allocator.allocate(sizeof(my_msg_srv__msg__Sphere__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_msg_srv__msg__Sphere__Sequence__init(array, size);
  if (!success) {
...
my_msg_srv__msg__Sphere__Sequence__destroy(my_msg_srv__msg__Sphere__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_msg_srv__msg__Sphere__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_msg_srv__msg__Sphere__Sequence__are_equal(const my_msg_srv__msg__Sphere__Sequence * lhs, const my_msg_srv__msg__Sphere__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_msg_srv__msg__Sphere__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_msg_srv__msg__Sphere__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_msg_srv__msg__Sphere);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_msg_srv__msg__Sphere * data =
      (my_msg_srv__msg__Sphere *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_msg_srv__msg__Sphere__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_msg_srv__msg__Sphere__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_msg_srv__msg__Sphere__copy(
